...
import Application_Form from "../Components/ApplicationForm";

const SearchMentor = () => (
  <Flex flexDirection="column" p="30px">
    <Flex ml="10px" mt="30px" mb="10px">
      <Heading color="#ffffff">Search Mentor</Heading>
    </Flex>
    <Flex m="30 px" p="10px" alignItems="center" mt="50px">
      <InputGroup>
        <InputLeftAddon backgroundColor="#2b2b2b" color="#ffffff">
          Find Mentor
        </InputLeftAddon>
        <Input
          ...
          minWidth="800px"
          maxWidth="800px"
          placeholder='Try "UX Designer" or "Machine Learning"'
        />
        <InputRightElement>
          <PlusSquareIcon name="email" color="#000000" mt="-30px" />
        </InputRightElement>
      </InputGroup>
    </Flex>
    <Flex p="10px" flexDirection="column" pt="40px">
      <Flex>
        <Button
          variant="ghost"
          size="md"
      ...
      <Flex mt="30px">
        ...
        >
          ...
          <option value="option3">Business & Management</option>
          <option value="option3">Product & Marheting</option>
        </Select>
        <Select
          placeholder="Skills"
          icon={<ChevronDownIcon />}
        ...
        >
          ...
          <option value="option2">Inida</option>
          <option value="option3">Any</option>
        </Select>
        <Select
        ...
        >
          ...
          <option value="option2">Messages</option>
...
const FindMentor = () => {
  ...
  return(
      <ChakraProvider resetCSS>
        <Flex flexDirection="column" backgroundColor="#040404" height="600VH">
          <SearchMentor />
          <Flex flexDirection="column" p="30px" pt="60px">
            <Box
              minWidth="800px"
              maxWidth="1000px"
              minHeight="600px"
